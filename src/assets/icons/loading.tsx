...
export default function Loading(props: LoadingProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height="auto" viewBox="0 0 24 24">
            <g fill="none" stroke="#5352f7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
